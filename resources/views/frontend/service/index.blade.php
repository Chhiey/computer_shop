...
<div class="row">
    ...
    <div class="col-md-4 col-xs-6">
        <div class="service">
            <div class="service-img">
                <img src="{{ asset('frontend/img/access/IMG_4364.jpg') }}" alt="Computer Repair">
            </div>
    ...
    <div class="col-md-4 col-xs-6">
        <div class="service">
            <div class="service-img">
                <img src="{{ asset('frontend/img/access/IMG_43312.jpg') }}" alt="PC Building">
            </div>
            <div class="service-body">
    ...
    <div class="col-md-4 col-xs-6">
        <div class="service">
            <div class="service-img">
                <img src="{{ asset('frontend/img/access/1.webp') }}" alt="Software Installation">
            </div>
            <div class="service-body">
