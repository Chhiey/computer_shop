        ...
        <div class="col-md-9">
            <div class="row" id="product-list">
                <div class="col-md-4 col-sm-6 product-item">
                    <div class="product">
                        <div class="product-img">
                            <img src="{{ asset('frontend/img/computer/photo_23_2025-02-07_23-03-18.JPG') }}" alt="">
                        </div>
                ...
                <div class="col-md-4 col-sm-6 product-item">
                    <div class="product">
                        <div class="product-img">
                        <img src="{{ asset('frontend/img/computer/photo_20_2025-02-07_23-03-18.JPG') }}" alt="">
                        </div>
                        <div class="product-body">
                ...
                <div class="col-md-4 col-sm-6 product-item">
                    <div class="product">
                        <div class="product-img">
                        <img src="{{ asset('frontend/img/computer/photo_29_2025-02-07_23-03-18.JPG') }}" alt="">
                        </div>
                        <div class="product-body">
                ...
                <div class="col-md-4 col-sm-6 product-item">
                    <div class="product">
                        <div class="product-img">
                        <img src="{{ asset('frontend/img/computer/photo_6_2025-02-07_23-03-18.JPG') }}" alt="">
                        </div>
                        <div class="product-body">
                ...
                <div class="col-md-4 col-sm-6 product-item">
                    <div class="product">
                        <div class="product-img">
                        <img src="{{ asset('frontend/img/computer/photo_14_2025-02-07_23-03-18.JPG') }}" alt="">
                        </div>
                        <div class="product-body">
                ...
                <div class="col-md-4 col-sm-6 product-item">
                    <div class="product">
                        <div class="product-img">
                        <img src="{{ asset('frontend/img/computer/photo_5_2025-02-07_23-03-18.JPG') }}" alt="">
                        </div>
                        <div class="product-body">
                ...
                <div class="col-md-4 col-sm-6 product-item">
                    <div class="product">
                        <div class="product-img">
                        <img src="{{ asset('frontend/img/computer/photo_2_2025-02-07_23-03-18.JPG') }}" alt="">
                        </div>
                        <div class="product-body">
                ...
                <div class="col-md-4 col-sm-6 product-item">
                    <div class="product">
                        <div class="product-img">
                        <img src="{{ asset('frontend/img/computer/photo_19_2025-02-07_23-03-18.JPG') }}" alt="">
                        </div>
                        <div class="product-body">
                ...
                <div class="col-md-4 col-sm-6 product-item">
                    <div class="product">
                        <div class="product-img">
                        <img src="{{ asset('frontend/img/computer/photo_12_2025-02-07_23-03-18.JPG') }}" alt="">
                        </div>
                        <div class="product-body">
