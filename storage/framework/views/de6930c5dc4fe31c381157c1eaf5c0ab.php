...
<div class="container">
    <div class="row" id="product-list">
        ...
        <div class="col-md-4 col-xs-6 product-item">
            <div class="product">
                <div class="product-img">
                    <img src="<?php echo e(asset('frontend/img/access/IMG_4336.jpg')); ?>" alt="VGA Card">
                </div>
        ...
        <div class="col-md-4 col-xs-6 product-item">
            <div class="product">
                <div class="product-img">
                   <img src="<?php echo e(asset('frontend/img/access/IMG_4348.JPG')); ?>" alt="Cooling Fan">
                </div>
                <div class="product-body">
        ...
        <div class="col-md-4 col-xs-6 product-item">
            <div class="product">
                <div class="product-img">
                    <img src="<?php echo e(asset('frontend/img/access/IMG_4334.jpg')); ?>" alt="Wireless Mouse">
                </div>
                <div class="product-body">
        ...
        <div class="col-md-4 col-xs-6 product-item">
            <div class="product">
                <div class="product-img">
                    <img src="<?php echo e(asset('frontend/img/access/IMG_4335.JPG')); ?>" alt="Keyboard">
                </div>
                <div class="product-body">
        ...
        <div class="col-md-4 col-xs-6 product-item">
            <div class="product">
                <div class="product-img">
                    <img src="<?php echo e(asset('frontend/img/access/IMG_4356.JPG')); ?>" alt="USB Drive">
                </div>
                <div class="product-body">
        ...
        <div class="col-md-4 col-xs-6 product-item">
            <div class="product">
                <div class="product-img">
                    <img src="<?php echo e(asset('frontend/img/access/IMG_4351.JPG')); ?>" alt="Headset">
                </div>
                <div class="product-body">
        ...
        <div class="col-md-4 col-xs-6 product-item">
            <div class="product">
                <div class="product-img">
                    <img src="<?php echo e(asset('frontend/img/access/IMG_4360.JPG')); ?>" alt="Power Supply">
                </div>
                <div class="product-body">
        ...
        <div class="col-md-4 col-xs-6 product-item">
            <div class="product">
                <div class="product-img">
                    <img src="<?php echo e(asset('frontend/img/access/IMG_4361.JPG')); ?>" alt="Monitor Stand">
                </div>
                <div class="product-body">
        ...
        <div class="col-md-4 col-xs-6 product-item">
            <div class="product">
                <div class="product-img">
                    <img src="<?php echo e(asset('frontend/img/access/IMG_4358.JPG')); ?>" alt="Cable Management Kit">
                </div>
                <div class="product-body">
...
<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mengly/Documents/Setec/web/Computer-Shop/resources/views/frontend/accessories/index.blade.php ENDPATH**/ ?>