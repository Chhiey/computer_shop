...
<body>
  ...
  <div class="shadow-lg p-3 mb-5 bg-body rounded">
    ...
    <div id="productSummary">
      ...
      <p id="discountDisplay">Discount : <span class="dic" id="discountValue"></span>%</p>
      <p id="discountAmountDisplay">Discount Amount : $ <span id="discountAmountValue"></span></p>
      <h1>
        <p id="totalAfterDiscountDisplay">Total After Discount : $ <span id="totalAfterDiscountValue"></span></p>
        <h1>
    </div>
...
</html><?php /**PATH D:\web\st15\resources\views/calculator.blade.php ENDPATH**/ ?>